(function (global, factory) {
	 ...
	 */
	function ImagePanorama ( image, user_radius = 9999, user_height = 8000, _geometry, _material ) {

	    const radius = user_radius;
	    const geometry = _geometry || new THREE.CylinderBufferGeometry( radius, radius, user_height, 64, 1, true);
